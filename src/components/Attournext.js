...
localStorage.setItem('adultCount', dates);
                    ...
                    />
                     ...
                     <div className="Adults  d-flex justify-content-between align-items-center py-4 p-2" style={{backgroundColor:'#f9f9f9' , borderTop:'1px solid black'}}>
                        ...
                        <div className="AdultsValue d-flex justify-content-between mx-2" style={{width:'150px', fontSize:'22px'}}>
                          ...
                          {children}
                          <span onClick={() => handleIncrementChildren()} style={{cursor:"pointer"}}>+</span>
                        </div>
                      </div> 
    
                      <div className="button py-4 text-center" style={{borderTop:'1px solid black'}}>
                       <Link to={`/cart/${send.id}`}> <button className="btn bg-primary text-white py-2 w-50" onClick={()=>Book()} >Book Now</button></Link>
                      </div>
